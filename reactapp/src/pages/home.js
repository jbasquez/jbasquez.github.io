              ...
              <div id="main-bio">
                ...
                <div className="row">
                  ...
                  <div data-aos="fade-right" className="col-lg-6 col-md-6 col-sm-12 col-xs-12 bg textColor bottom">
                    ...
                    <p className="textColor">Highly motivated, hard working individual, with a passsion for Software Development. I enjoy agile working environments, see every challenge as a opportunity to learn, and have many skills such as photo and video editing.</p>
                  </div>
