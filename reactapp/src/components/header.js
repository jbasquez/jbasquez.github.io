...
function NavBar(){
    return(
      <nav data-aos="fade-down" class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand col-lg-1 col-md-1 col-sm-12 col-xs-12" href="https://docs.google.com/document/d/1038_sdzmqFadOf_M20GMJyJ3LrQY_zHgHVfo0ud0V20/edit?usp=sharing">Resume</a>
      </nav>
    )
}
