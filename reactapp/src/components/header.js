...
function NavBar(){
    return(
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand col-lg-1 col-md-1 col-sm-12 col-xs-12" href="/projects">Portfolio</a>
        <a class="navbar-brand col-lg-1 col-md-1 col-sm-12 col-xs-12" href="/contactInfo">Contact</a>
